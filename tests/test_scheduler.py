...
class TestMeetingScheduler(unittest.TestCase):
  ...
  def test_find_availability_lunch_error(self):
    ...
    with self.assertRaises(Exception) as context:
      s.find_availability(test_input['people'], test_input['officeHours'], test_input['lunch'])
  ...
  def test_find_availability_people_no_name(self):
    ...
    self.assertTrue('Please provide a name for each person' in context.exception)
  ...
  def test_find_availability_people_no_meetings(self):
    ...
    self.assertTrue('Please provide a list of meeting times for each person' in context.exception)
  ...
  def test_find_availability_invalid_time(self):
    ...
    self.assertTrue('Times must be formatted as hh:mm:ss' in context.exception)
